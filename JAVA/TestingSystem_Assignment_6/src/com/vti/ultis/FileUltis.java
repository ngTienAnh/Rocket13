...
public class FileUltis {
	...
	public static void isFolderOrFile(String pathFile) {
		...
		if (file.isDirectory()) {
			System.out.println("�?ây là 1 Foder");
		} else if (file.isFile()) {
			System.out.println("�?ây là 1 file");
		} else {
			System.out.println("�?ây không phải đư�?ng dãn, cũng không phải file");
		}
	}
	...
	public static String[] getAllFileName(String path) {
		...
		if (!isFolder(path)) {
			System.out.println("�?ây không phải là đư�?ng dẫn!!");
			return null;
		} else {
			return file.list();
		}
	...
	public static void renameFile(String pathFile, String newName) throws Exception {
		...
		System.out.println("�?ổi têm file thành công");
	}
