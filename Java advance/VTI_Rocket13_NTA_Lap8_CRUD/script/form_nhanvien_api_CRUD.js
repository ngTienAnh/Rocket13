...
$(function () {
    ...
    $('#Main_Form_ID').submit(function () {
        ...
        var v_ID_ID = $('#emid').val()
        var v_Email_ID = $('#ememail').val()
        var v_Username_ID = $('#emusername').val()
        var v_Fullname_ID = $('#emfullname').val()
        ...
        $.post("http://localhost:8080/api/v1/accounts/", account,
            function (data, status) {
                ...
                // success// Hàm này để hiển thị thông tin account ở table
                getListEmployees();
            });
        return false;
